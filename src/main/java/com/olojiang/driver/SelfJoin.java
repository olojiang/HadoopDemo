...
import com.olojiang.mapper.SelfJoinMapper;
import com.olojiang.reducer.SelfJoinReducer;

public class SelfJoin {
	public static void main(String[] args) {
		if(args.length != 2) {
			System.err.println("Missing Parameter: SelfJoin inputDir outputDir");
			System.exit(2);
		}
		...
		// Create Job
		try {
			Job job = Job.getInstance(conf, "Self Join Table to find Child GrandParent Relation");
